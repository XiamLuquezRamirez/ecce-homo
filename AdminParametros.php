...
<html lang="en" class="no-js">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Funeraria la Esperanza | Paramatros Generales</title>
        ...
        <script src="Js/AdminParametros.js" type="text/javascript"></script>
    </head>
    <!-- END HEAD -->
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                    ...
                    <!-- BEGIN PAGE HEADER-->
                     <h3 class="page-title">
                         SISTEMA INTEGRAL DE GESTI&Oacute;N FUNERARIA LA ESPERANZA
                    </h3>
                    <div class="page-bar">
                    ...
                    <!-- BEGIN PAGE CONTENT-->
                    <div class="tiles">
                         <?php if($_SESSION['gpargen1']=="s"){?>
                        <div id="btn_DatEmpre" class="tile bg-blue-steel">
                            <div class="tile-body">
                        ...
                        <?php }?>
                         <?php if($_SESSION['gpargen2']=="s"){?>
                        <div id="btn_Age_Cli" class="tile bg-blue-steel">
                            <div class="tile-body">
                        ...
                        <?php }?>
                           ...
                           <?php if($_SESSION['gpargen3']=="s"){?>
                        <div id="btn_Funera" class="tile bg-green-turquoise">
                            <div class="tile-body">
                                <i class="fa fa-institution"></i>
                            </div>
                            <div class="tile-object">
                                <div class="name">
                                    Gesti&oacute;n de Funerarias
                                </div>
                            </div>
                        </div>
                         <?php }?>
                         ...
                         <?php if($_SESSION['gpargen4']=="s"){?>
                        <div id="btn_Necesi" class="tile bg-purple">
                            <div class="tile-body">
                                <i class="fa fa-bookmark"></i>
                            </div>
                            <div class="tile-object">
                                <div class="name">
                                    Gesti&oacute;n de Necesidades
                                </div>
                            </div>
                        </div>
                        <?php }?>
                       
                        <?php if($_SESSION['gpargen5']=="s"){?>
                        <div id="btn_Cementerio" class="tile bg-blue-steel">
                            <div class="tile-body">
                        ...
                        <?php }?>
                        <?php if($_SESSION['gpargen6']=="s"){?>
                        <div id="btn_Iglesias" class="tile bg-blue-steel">
                            <div class="tile-body">
                        ...
                        <?php }?>
                        <?php if($_SESSION['gpargen7']=="s"){?>
                        <div id="btn_Consec" class="tile bg-blue-steel">
                            <div class="tile-body">
