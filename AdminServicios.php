...
<html lang="en" class="no-js">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Funeraria la Esperanza | Administraci&oacute;n de Servicios</title>
        ...
        <script src="Js/AdminServicios.js" type="text/javascript"></script>
    </head>
    <!-- END HEAD -->
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                    ...
                    <!-- BEGIN PAGE HEADER-->
                     <h3 class="page-title">
                       SISTEMA INTEGRAL DE GESTIÓN FUNERARIA LA ESPERANZA
                    </h3>
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            <li>
                                <i class="fa fa-home"></i>
                                <a href="AdminServicios.php">Administración de Servicios</a>
                            </li>
                    ...
                    <!-- BEGIN PAGE CONTENT-->
                    <div class="tiles">
                         <?php if($_SESSION['gesser1']=="s"){?>
                        <div id="btn_requi" class="tile bg-blue-steel">
                            <div class="tile-body">
                        ...
                        <?php }?>
                           ...
                           <?php if($_SESSION['gesser2']=="s"){?>
                        <div id="btn_Arriendo" class="tile bg-green-turquoise">
                            <div class="tile-body">
                                <i class="fa fa-save"></i>
                            </div>
                            <div class="tile-object">
                         ...
                         <?php }?>
                         <?php if($_SESSION['gesser3']=="s"){?>
                        <div id="btn_Venta" class="tile bg-purple-plum">
                            <div class="tile-body">
                                <i class="fa fa-save"></i>
                            </div>
                            <div class="tile-object">
                         ...
                         <?php if($_SESSION['gesser4']=="s"){?>
                        <div id="btn_Previ" class="tile bg-purple">
                            <div class="tile-body">
                                <i class="fa fa-save"></i>
                            </div>
                            <div class="tile-object">
                        ...
                        <?php }?>
                        <?php if($_SESSION['gesser5']=="s"){?>
                        <div id="btn_Consig" class="tile bg-blue-steel">
                            <div class="tile-body">
                                <i class="fa fa-save"></i>
                            </div>
                            <div class="tile-object">
