...
<html lang="en" class="no-js">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Funeraria la Esperanza | Administraci&oacute;n</title>
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                    ...
                    <!-- BEGIN PAGE CONTENT-->
                    <div class="tiles">
                         <?php if($_SESSION['gopgen1']=="s"){?>
                        <div id="btn_Noti" class="tile bg-blue-steel">
                            <div class="tile-body">
                        ...
                        <?php }?>
                         <?php if($_SESSION['gopgen2']=="s"){?>
                        <div id="btn_Gal" class="tile bg-blue-steel">
                            <div class="tile-body">
                        ...
                        <?php }?>
                           ...
                           <?php if($_SESSION['ggesserv']=="s"){?>
                        <div id="btn_Serv" class="tile bg-green-turquoise">
                            <div class="tile-body">
                         ...
                         <?php if($_SESSION['gpargen']=="s"){?>
                        <div id="btn_Para_Gen" class="tile bg-purple">
                            <div class="tile-body">
                        ...
                        <?php }?>
                        <?php if($_SESSION['gestUsu1']=="s"){?>
                        <div id="btn_usu" class="tile bg-blue-steel">
                            <div class="tile-body">
                        ...
                        <?php if($_SESSION['gesAudi']=="s"){?>
                        <div id="btn_Audi" class="tile bg-green-turquoise">
                            <div class="tile-body">
                                <i class="fa fa-users"></i>
                            </div>
                            <div class="tile-object">
