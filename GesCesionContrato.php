...
<html lang="en" class="no-js">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Cesi&oacute;n de Contrato | Funeraria La Esperanza </title>
        ...
        <script src="Js/GesCesionContrato.js" type="text/javascript"></script>
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            <li>
                                ...
                                <a href="GesCesionContrato.php">Cesi&oacute;n de Contrato</a>
                    ...
                    <!-- responsive terceros-->
                    <div id="clientes2" class="modal fade" tabindex="-1" data-width="760">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                            <h4 class="modal-title" id='titformi'>Selecci&oacute;n Clientes </h4>
                        </div>
                                        ...
                                        <div class='row'>
                                            <div class='col-md-12'>
                                                <div id="sample_1_filter" class="dataTables_filter">
                                                    <label>
                                                        Busqueda:
                                                        <input class="form-control input-small input-inline" onkeypress="$.busqCli2(this.value);" onchange="$.busqCli2(this.value);" id="busq_terce" type="search" placeholder="" aria-controls="sample_1">
                                                    </label>
                                                </div>
                                                <div class="table-scrollable">
                                                    <div id="tab_Clientes2" style="height: 250px;overflow: scroll;">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <ul class="nav nav-tabs">
                        <li class="active" id="tab_01_pp">
                            <a href="#tab_01" data-toggle="tab"> Listado de Cesi&oacute;n de Contrato</a>
                        </li>
                        <li id="tab_02_pp">
                            <a href="#tab_02" data-toggle="tab" id="atitulo">Crear Cesi&oacute;n de Contraton</a>
                        </li>
                    </ul>
                                                        ...
                                                        <div class='row'>
                                                            ...
                                                            <div class='col-md-12'>
                                                                <div class="table-scrollable">
                                                                    ...
                                                                    <div id="tab_TipDoc" style="height: 250px;width: 1200px;overflow: scroll;">
                        ...
                        <div class="tab-pane fade" id="tab_02">
                            ...
                            <div class="portlet box purple-intense">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-angle-right"></i>Informaci&oacute;n de la Cesi&oacute;n de Contrato.
                                    </div>
                                    <div class="tools">
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane fade active in" id="tab_inf">
                                                ...
                                                <div class='portlet box blue'>
                                                    <div class='portlet-title'>
                                                        <div class='caption'>
                                                            <i class='fa fa-angle-right'></i>Datos del Cesionario
                                                        </div>
                                                        <div class='tools'>
                                                            <a href='javascript:;' class='collapse'></a>
                                                        </div>
                                                    ...
                                                    <div class='portlet-body form'>
                                                        <input type="hidden" id="acc" value="1" /><input type="hidden" id="txt_id" value="" />
                                                        <div class='form-body'>
                                                            <div class='row'>
                                                                <div class="col-md-3">
                                                                    <label class="control-label">C.C &oacute; NIT: <span class="required">* </span></label>
                                                                    <div class="form-inline">
                                                                        <div class="form-group">
                                                                            <div class="input-group">
                                                                                <input type="text" id="txt_idenCesi" class="form-control"  />
                                                                                <input type="hidden" id="txt_nuevo" value="SI" class="form-control"  />
                                                                                <input type="hidden" id="txt_nuevoSec" value="SI" class="form-control"  />
                                                                                <span class="input-group-btn">
                                                                                    <button type="button" id="btn_para" onclick="$.AbrirCesionario()" class="btn green-meadow">
                                                                                        <i class="fa fa-search fa-fw"/></i>
                                                                                    </button>
                                                                                </span>
                                                                ...
                                                                <div class='col-md-9' >
                                                                    <div class='form-group'>
                                                                        <label class='control-label'>Nombre:</label>
                                                                        <input type='text'  onkeyup='this.value = this.value.toUpperCase()'  value=""  id='txt_NomCesi' class='form-control'/>
                                                                ...
                                                                <div class='col-md-6' >
                                                                    <div class='form-group'>
                                                                        <label class='control-label'>Direcci&oacute;n:</label>
                                                                        <input type='text'  onkeyup='this.value = this.value.toUpperCase()' id='txt_DirCesi' class='form-control'/>
                                                                    </div>
                                                                </div>
                                                                <div class='col-md-3'>
                                                                    <div class='form-group'>
                                                                        <label class='control-label'>Barrio:</label>
                                                                        <input type='text'  onkeyup='this.value = this.value.toUpperCase()' id='txt_BarrCesi' class='form-control'/>
                                                                    </div>
                                                                </div>
                                                                <div class='col-md-3'>
                                                                    <div class='form-group'>
                                                                        <label class='control-label'>Tel&eacute;fono:</label>
                                                                        <input type='text'  onkeyup='this.value = this.value.toUpperCase()' id='txt_TelCesi' class='form-control'/>
                                                                    </div>
                                                                </div>
                                                ...
                                                <div class='portlet box blue'>
                                                    <div class='portlet-title'>
                                                        <div class='caption'>
                                                            <i class='fa fa-angle-right'></i>Datos De la Cesión del Contrato
                                                        </div>
                                                        <div class='tools'>
                                                            <a href='javascript:;' class='collapse'></a>
                                                        </div>
                                                    ...
                                                    <div class='portlet-body form'>
                                                        ...
                                                        <div class='form-body'>
                                                            ...
                                                            <div class='row'>
                                                                ...
                                                                <div class='col-md-4' id="CobUbi" style="display: none;">
                                                                    <div class='form-group'>
                                                                        <label class='control-label'>Ubicaci&oacute;n:</label>
                                                                ...
                                                                <div class='col-md-4'>
                                                                    <div class='form-group'>
                                                                        <label class='control-label'>Tipo de Traspado:</label>
                                                                        <select class='form-control' id="CbTipTras" name="options2">
                                                                ...
                                                                <div class='col-md-4'>
                                                                    <div class='form-group'>
                                                                        <label class='control-label'>Entrega de Documento:</label>
                                                                        <select class='form-control'   onchange="$.titpro();" id="CbEntDoc" name="options2">
                                                                            <option value=" ">Sel...</option>
                                                                            <option value="TITULO DE PROPIEDAD">TITULO DE PROPIEDAD</option>
                                                                            <option value="DENUNCIA POR PERDIDA DE DOCUMENTO">DENUNCIA POR PERDIDA DE DOCUMENTO</option>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                                <div class='col-md-3'>
                                                                    <div class='form-group'>
                                                                        <label class='control-label'>No. Titulo de Propiedad:</label>

                                                                        <input type='text' id='txt_TitPro' disabled value="" class='form-control' />
                                                                    </div>
                                                                </div>

                                                                <div class='col-md-12'>
                                                                    <div class='form-group'>
                                                                        <label class='control-label'>Nota Aclaratoria:</label>
                                                                        <textarea id="txt_Nota" rows="2" onkeyup='this.value = this.value.toUpperCase()' class='form-control' style="width: 100%"></textarea>
                                                                    </div>
                                                                </div>
