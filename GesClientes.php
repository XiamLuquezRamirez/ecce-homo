...
<html lang="en" class="no-js">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Gesti&oacute;n de Clientes | Funeraria La Esperanza </title>
        ...
        <script src="Js/GesClientes.js" type="text/javascript"></script>
                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                ...
                                <a href="GesClientes.php">Gesti&oacute;n de Clientes  </a>
                            </li>
                        </ul>
                    </div>
                    <!-- END PAGE HEADER-->
                    ...
                    <div id="responsive" class="modal fade" tabindex="-1" data-width="760">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id='titformi'>Datos del Cliente</h4>
                    ...
                    <div class="portlet box purple-intense">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-angle-right"></i>Gesti&oacute;n de Clientes
                            </div>
                            <div class="tools">
