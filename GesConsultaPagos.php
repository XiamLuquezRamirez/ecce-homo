...
<html lang="en" class="no-js">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Consulta de Pagos | Funeraria La Esperanza </title>
        ...
        <script src="Js/GesConsultasPagos.js" type="text/javascript"></script>
                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            <li>
                                ...
                                <a href="GesConsultasRetra.php.php">Consulta de Pagos</a>
                    ...
                    <div class="portlet box purple-intense">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-angle-right"></i>Gesti&oacute;n de Consulta de Pagos
                            </div>
                            <div class="tools">
                                                            ...
                                                            <div class='row'>
                                                                <div class='col-md-3'>
                                                                    <div class='form-group'>
                                                                        ...
                                                                        <select class='form-control'  id="Cbconsu" name="options2">
