...
<html lang="en" class="no-js">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Consulta de Cartera | Funeraria La Esperanza </title>
        ...
        <script src="Js/GesConsultas.js" type="text/javascript"></script>
                                                            ...
                                                            <div class='row'>
                                                                <div class='col-md-3'>
                                                                    <div class='form-group'>
                                                                        ...
                                                                        <select class='form-control'  id="CbconsuTip" name="options2">
                                                                            ...
                                                                            <option value="PREVI">PREVISI&Oacute;N ANUAL EXEQUIAL</option>
                                                                            <option value="VENTA">VENTA DE OSARIO O LOTE</option>
                                                                ...
                                                                <div class='col-md-4'>
                                                                    <div class='form-group'>
                                                                        ...
                                                                        <select class='form-control' onchange="$.consu();" id="Cbconsu" name="options2">
                                                                            <option value=" ">Select...</option>
                                                                            <option value="CONSUL1">CLIENTES AL DIA</option>
                                                                            <option value="CONSUL2">CLIENTES ATRASADOS (1) CUOTA</option>
                                                                            <option value="CONSUL3">CLIENTES ATRASADOS (2) CUOTA</option>
                                                                            <option value="CONSUL4">CLIENSTE CON MAS DE (3) CUOTA</option>
                                                                ...
                                                                <div class='col-md-4'>
                                                                    <div class='form-group'>
                                                                        ...
                                                                        <input class="form-control"  onchange="$.busqFunera(this.value);" id="busq_centro" type="search" placeholder="" aria-controls="sample_1">
                                                                ...
                                                                <div class='col-md-12'>
                                                                    ...
                                                                    <div style="text-align: right;">
                                                                        <label class='control-label'><b>Valor Total Cuotas Atrasadas:</b></label>
                                                                        <label class='control-label' id="val_atrasado" >$ 0,00</label>
                                                                    </div>
                                                                    <div style="text-align: right;">
                                                                        <label>
