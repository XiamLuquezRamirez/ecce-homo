                                            ...
                                            <div class='row'>
                                                ...
                                                <div class='col-md-3'>
                                                    <div class='form-group'>
                                                        ...
                                                        <input type='text' disabled  onclick="this.select();" value="$ 0,00" onblur="textm(this.value, this.id)" id='txt_ValCuota' class='form-control'/>
                                            ...
                                            <div class='row'>
                                                <div class='col-md-3'>
                                                    <div class='form-group'>
                                                        ...
                                                        <input type='text' onchange="$.validarAnios(this.value);" maxlength="4" id='txt_anio' class='form-control' />
                                                    </div>
                                                </div>
                                                <div class='col-md-4'>
                                                    <div class='form-group'>
                                ...
                                <div class="portlet-body form">
                                    <div class="form-body">
                                        <ul class="nav nav-tabs">
                                            ...
                                            <li>
                                                <a href="#tab_5" data-toggle="tab"> Anexos</a>
                                            </li>
                                        ...
                                        <div class="tab-content">
                                                        ...
                                                        <div class='form-body'>
                                                            <div class='row'>
                                                                <div class='col-md-12'>
                                                                    <div class='form-group'>
                                                                        <label class='control-label'>Observaci&oacute;n</label>
                                                                        <textarea id="txt_obser" rows="3" class='form-control' style="width: 100%"></textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="tab-pane fade" id="tab_2">
                                                ...
                                                <div class='portlet box blue'>
                                                    ...
                                                    <div class='portlet-body form'>
                                                        ...
                                                        <input type="hidden" id="FilaEdit" value="0" class="form-control"  />
                                                        <div class='form-body'>
                                                            ...
                                                            <div class='row'>
                                                                ...
                                                                <div class='col-md-12' style="text-align: right">
                                                                    <div class='form-group' id="Btn_AddBas">
                                                                ...
                                                                <div class='col-md-12'>
                                                                    <div class='form-group'>
                                                                        <table class='table table-bordered table-striped table-condensed flip-content' id="tb_GrupBas">
                                                                            <thead>
                                                                                <tr>
                                                                                    <td>
                                                                                        <i class='fa fa-angle-right'></i> #
                                                    ...
                                                    <div class='portlet-body form'>
                                                        ...
                                                        <div class='form-body'>
                                                            <div class='row'>
                                                                ...
                                                                <div class='col-md-12' style="text-align: right">
                                                                    <div class='form-group' id="Btn_AddSec">
                                            ...
                                            <div class="tab-pane fade" id="tab_5">
                                                ...
                                                <div class='portlet box blue'>
                                                    <div class='portlet-title'>
                                                        <div class='caption'>
                                                            <i class='fa fa-angle-right'></i>Anexos
                                                        </div>
                                                        <div class='tools'>
                                                            <a href='javascript:;' class='collapse'></a>
                                                            <input type="hidden" id="cont" value="0" />
