...
<html lang="en" class="no-js">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Constancia de Consignaci&oacute;n | Funeraria La Esperanza </title>
        ...
        <script src="Js/GesConstancia.js" type="text/javascript"></script>
                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                ...
                                <a href="GesCostanciasConsig.php">Constancia de Consignaci&oacute;n</a>
                            </li>
                        </ul>
                    </div>
                    <!-- responsive terceros-->
                    ...
                    <ul class="nav nav-tabs">
                        <li class="active" id="tab_01_pp">
                            <a href="#tab_01" data-toggle="tab"> Listado de Constacia de Consignaci&oacute;n</a>
                        </li>
                        <li id="tab_02_pp">
                            <a href="#tab_02" data-toggle="tab" onclick="$.conse();" id="atitulo">Crear Constancia</a>
                        </li>
                    </ul>
                        ...
                        <div class="tab-pane fade" id="tab_02">
                            ...
                            <div class="portlet box purple-intense">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-angle-right"></i>Informaci&oacute;n de la Constancia
                                    </div>
                                    <div class="tools">
                                                    ...
                                                    <div class='portlet-body form'>
                                                        ...
                                                        <div class='form-body'>
                                                            ...
                                                            <div class='row'>
                                                                <div class='col-md-3'>
                                                                    <div class='form-group'>
                                                                        <input type="hidden" id="consFact" value="" />
                                                                        <input type="hidden" id="txt_valetra" value="" />
