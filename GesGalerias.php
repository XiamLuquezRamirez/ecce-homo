...
<html lang="en" class="no-js">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Gesti&oacute;n de Galerias | Funeraria La Esperanza </title>
        ...
        <script src="Js/GesGalerias.js" type="text/javascript"></script>
                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            <li>
                                ...
                                <a href="#">Gesti&oacute;n de Galerias</a>
                    ...
                    <div id="responsive" class="modal fade" tabindex="-1" data-width="760">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id='titformi'>Datos de la Galeria</h4>
                                            ...
                                            <div class='row'>
                                                ...
                                                <div class='col-md-12'>
                                                    <div class='form-group'>
                                                        <label class='control-label'>T&iacute;tulo de la Galeria:</label>
                                                        <input type='text'   id='txt_Titu' class='form-control'/><input type="hidden" id="acc" value="1" /><input type="hidden" id="text_id" value="1" />
                                                    </div>
                                                </div>
                                                <div class='col-md-12'>
                                                    <div class='form-group'>
                                                        <label class='control-label'>Descripci&oacute;n:</label>
                                                        <textarea id="txt_desc" rows="3"  class='form-control' style="width: 100%"></textarea>
                                                    </div>
                                                </div>
                    ...
                    <div id="responsive2" class="modal fade" tabindex="-1" data-width="760">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                            <h4 class="modal-title" id='titformi'>Imagenes en Galeria</h4>
                            ...
                            <div class="row">
                                <ul class="nav nav-tabs">
                                    <li class="active" id="tab_01_pp">
                                        <a href="#tab_01" data-toggle="tab">Imagenes Cargadas</a>
                                    </li>
                                    <li id="tab_02_pp">
                                        <a href="#tab_02" data-toggle="tab" id="atitulo">Subir Imagenes</a>
                                    </li>
                                </ul>
                                                ...
                                                <div class="tab-content">
                                                    <div class="tab-pane fade active in" id="tab_011">
                                                        <div class="table-scrollable">
                                                            ...
                                                            <div id="tab_Img" style="height: 250px;overflow: scroll;">
                                            ...
                                            <form  method="post" enctype="multipart/form-data" >
                                                <div class='form-body'>
                                                    ...
                                                    <div class="form-actions right" >
                                                        <button type="button" class="btn green" id="btn_guardarImg"><i class="fa fa-save"></i> Guardar</button>
                                                        <button type="button" disabled class="btn purple" id="btn_nuevo"><i class="fa fa-file-o"></i> Nuevo</button>
                    ...
                    <div class="portlet box purple-intense">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-angle-right"></i>Gesti&oacute;n de Galerias
                            </div>
                            <div class="tools">
                        ...
                        <div class="portlet-body form">
                            <form action="#" class="horizontal-form">
                                <div class="form-body">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane fade active in" id="tab_14">
                                            <p>
                                                            ...
                                                            <div class='row'>
                                                                <div class='col-md-12'>
                                                                    <div id="sample_1_filter" class="dataTables_filter">
                                                                        <label>
                                                                            Busqueda:
                                                                            <input class="form-control input-small input-inline" onchange="$.busqGale(this.value);" id="busq_centro" type="search" placeholder="" aria-controls="sample_1">
                                                                        </label>
