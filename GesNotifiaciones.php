...
<html lang="en" class="no-js">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Notificaciones a Clientes | Funeraria La Esperanza </title>
        ...
        <script src="Js/GesNotificacion.js" type="text/javascript"></script>
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                    ...
                    <!-- responsive -->
                    <div id="ImprNoti" class="modal fade" tabindex="-1" data-width="600">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                            <h4 class="modal-title" id='titformi'>Contrato de Arriendo</h4>
                        </div>
                                    ...
                                    <form action='#' id="formnot" class='horizontal-form'>
                                        <div class='form-body'>
                                            <div class='row'>
                                                ...
                                                <div class='col-md-6'>
                                                    <label class='control-label'>Ingresar Tiempo de Arriendo:</label>
                                                    <input type='text' id='txt_Tiempo_' value="" class='form-control' />
                                                    <input type='hidden' id='idContArr' value="" class='form-control' />
                                            ...
                                            <div id="bot_TipDoc" style="float:right;">
                                                <button type="button" class="btn blue" id="btn_PrintNotifi"><i class="fa fa-print"></i> Imprimir</button>
                    ...
                    <div class="portlet box purple-intense">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-angle-right"></i>Gesti&oacute;n de Notificaciones
                            </div>
                            <div class="tools">
                                                    ...
                                                    <form action='#' class='horizontal-form'>
                                                        <div class='form-body'>
                                                            ...
                                                            <div class='row'>
                                                                ...
                                                                <div class='col-md-3'>
                                                                    <div class='form-group'>
                                                                        <label class='control-label'>  Notificar para:</label>
                                                                        <select class='form-control' onchange="$.consu();" id="Cbconsu" name="options2">
                                                                            <!--
                                                                                                                                                            <option value="CONSUL1">PREVISI&Oacute;N ANUAL EXEQUIAL</option>
                                                                                                                                                            <option value="CONSUL2">VENTA DE OSARIO O LOTE</option>-->
                                                                            <option value="CONSUL3">ARRIENDO DE B&Oacute;VEDA</option>
                                                                ...
                                                                <div class='col-md-2'>
                                                                    <div class='form-group'>
                                                                        ...
                                                                        <input type='text' id='txt_fecha_ini' value="<?php echo date('Y-m-d'); ?>" class='form-control' readonly/>
                                                                ...
                                                                <div class='col-md-2'>
                                                                    <div class='form-group'>
                                                                        ...
                                                                        <input type='text' id='txt_fecha_fin' value="<?php echo date('Y-m-d'); ?>" class='form-control' readonly/>
                                                                ...
                                                                <div class='col-md-12' >
                                                                    <div id="sample_1_filter" class="dataTables_filter">
                                                                        ...
                                                                        <label style="display: none;">
                                                                            ...
                                                                            <input class="form-control input-large input-inline"  onchange="$.busqClientes(this.value);" id="busq_centro" type="search" placeholder="" aria-controls="sample_1">
                                                                        </label>
                                                                    </div>

                                                                    <div class="table-scrollable">

                                                                        <div id="tab_TipDoc" style="height: 350px;overflow: scroll;">
                                                                ...
                                                                <div class='col-md-12'   >
                                                                    ...
                                                                    <div id="bot_TipDoc" style="float:right;">
                                                                        ...
                                                                        <button type="button" class="btn blue-dark" id="btn_Notificar"><i class="fa fa-info"></i> Notificar</button>
                                                                    </div>
                                                                </div>
