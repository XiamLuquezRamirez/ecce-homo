...
<html lang="en" class="no-js">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Orden de Exhumaci&oacute;n | Funeraria La Esperanza </title>
        ...
        <script src="Js/GesOrdenExhumacion.js" type="text/javascript"></script>
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            <li>
                                ...
                                <a href="GesOrdenInhumacion.php">Orden de Exhumaci&oacute;n</a>
                    ...
                    <div id="contratos" class="modal fade" tabindex="-1" data-width="760">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                            <h4 class="modal-title" id='titformi'>Selecci&oacute;n Contrato </h4>
                        </div>
                        <div class="modal-body">
                            <div class="row">
                                <div class='portlet-body form'>
                                        ...
                                        <div class='row'>
                                            <div class='col-md-12'>
                                                <div id="sample_1_filter" class="dataTables_filter">
                                                    <label>
                                                        Busqueda:
                                                        <input class="form-control input-small input-inline" onkeypress="$.busqCont(this.value);" onchange="$.busqCont(this.value);" id="busq_contra" type="search" placeholder="" aria-controls="sample_1">
                                                    </label>
                                                </div>
                                                <div class="table-scrollable">
                                                    <div id="tab_Contratos" style="height: 250px;overflow: scroll;">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <ul class="nav nav-tabs">
                        <li class="active" id="tab_01_pp">
                            <a href="#tab_01" data-toggle="tab"> Listado de Exhumaciones</a>
                        </li>
                        <li id="tab_02_pp">
                            <a href="#tab_02" data-toggle="tab" onclick="$.conse();" id="atitulo">Crear Orden de Exhumación</a>
                        </li>
                    </ul>
                                                        ...
                                                        <div class='row'>
                                                            ...
                                                            <div class='col-md-12'>
                                                                <div class="table-scrollable">
                                                                    ...
                                                                    <div id="tab_TipDoc" style="height: 400px;width: 1200px;overflow: scroll;">
                        ...
                        <div class="tab-pane fade" id="tab_02">
                            ...
                            <div class="portlet box purple-intense">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-angle-right"></i>Informaci&oacute;n de la Exhumaci&oacute;n.
                                    </div>
                                    <div class="tools">
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane fade active in" id="tab_inf">
                                                            ...
                                                            <div class='row'>
                                                                <div class='col-md-12'>
                                                                    <div class='form-group'>
                                                                        ...
                                                                        <select class="form-control" data-placeholder="Seleccione..."  onchange="$.habTitu();" id="TipProp"  name="options2">
                                                                            <option value=''>Select...</option>
                                                                            <option value='Arriendo'>Arriendo</option>
                                                                            <option value='Propio'>Propia</option>
                                                                        </select>

                                                                    </div>
                                                                </div>

                                                                <div  style="display: none;" id="div-contrato">
                                                                <div class="col-md-3">
                                                                        <label class="control-label">Contrato de Arriendo: <span class="required">* </span></label>
                                                                        <div class="form-inline">
                                                                            <div class="form-group">
                                                                                <div class="input-group">
                                                                                    <input type="text" id="txt_contrato" class="form-control"  />
                                                                                    <input type="hidden" id="txt_id_contrato" class="form-control"  />
                                                                                    <span class="input-group-btn">
                                                                                        <button type="button" id="btn_para" onclick="$.AbrirContrato()" class="btn green-meadow">
                                                                ...
                                                                <div  style="display: none;" id="TextTit">
                                                                    <div class="col-md-3">
                                                                        ...
                                                                        <div class="form-inline">
                                                                            <div class="form-group">
                                                                                <div class="input-group">
                                                                                    ...
                                                                                    <input type="hidden" id="txt_id_cont" class="form-control"  />
                                                ...
                                                <div class='portlet box blue'>
                                                    <div class='portlet-title'>
                                                        <div class='caption'>
                                                            <i class='fa fa-angle-right'></i>Datos De la Orden de Exhumaci&oacute;n
                                                        </div>
                                                        <div class='tools'>
                                                            <a href='javascript:;' class='collapse'></a>
                                                        </div>
                                                            ...
                                                            <div class='row'>
                                                                <div class='col-md-3'>
                                                                    <div class='form-group'><input type="hidden" id="cons" value="" /><input type="hidden" id="acc" value="1" /><input type="hidden" id="txt_id" value="1" /><input type="hidden" id="txt_fec" value="<?php echo date('Y-m-d'); ?>" />
                                                                        <label class='control-label'>Orden de Exhumaci&oacute;n No:</label>
                                                                ...
                                                                <div class='col-md-3'>
                                                                    <div class='form-group'>
                                                                        ...
                                                                        <select class="form-control" data-placeholder="Seleccione..." onchange="$.InfCem();"  id="Cbcemen"  name="options2">
                                                                            <option value=''>Select...</option>
                                                                ...
                                                                <div class='col-md-8' id="TextUbi">
                                                                    <div class='form-group'>
                                                                        <label class='control-label'>Ubicaci&oacute;n:</label>
                                                                        <input type='text' id='txt_Ubic'  value="" class='form-control' />

                                                                    </div>
                                                                </div>

                                                                <div class='col-md-8' id="CobUbi" style="display: none;">
                                                                    <div class='form-group'>
                                                                        <label class='control-label'>Ubicaci&oacute;n:</label>
                                                                        <select class="form-control select2me" data-placeholder="Seleccione..."  onchange="$.InfUbi();" id="CbUbic" name="options2">
                                                                            <option value=''>Select...</option>
                                                                        </select>
                                                                ...
                                                                <div class='col-md-4'>
                                                                    <div class='form-group'>
                                                                        ...
                                                                        <select class="form-control" data-placeholder="Seleccione..."  id="CbPosic"  name="options2">
                                                                            <option value=''>Select...</option>
                                                                            <option value='(1) PTO'>Primer Puesto</option>
                                                                            <option value='(2) PTO'>Segundo Puesto</option>
                                                                        </select>
                                                                ...
                                                                <div class='col-md-4'>
                                                                    <div class='form-group'>
                                                                        ...
                                                                        <input type='text' id='txt_NomFalle'   value="" class='form-control' />
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class='col-md-2'>
                                                                    <div class='form-group'>
                                                                        ...
                                                                        <input type='text' id='txt_FecInhu'  value="" class='form-control' />
                                                                    </div>
                                                                </div>
                                                                <div class='col-md-3'>
                                                                    <div class='form-group'>
                                                                        <label class='control-label'>Para Trasladar a:</label>

                                                                        <input type='text' id='txt_Trasla'   value="" class='form-control' />
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class='col-md-3'>
                                                                    <div class='form-group'>
                                                                        <label class='control-label'>Fecha y Hora de Exhumaci&oacute;n:</label>

                                                                        <input type='text' id='txt_fecha_Exh' value="" class='form-control' readonly/>
                                                                    </div>
                                                                </div>

                                                                <div class='col-md-4'>
                                                                    <div class='form-group'>
                                                                        <label class='control-label'>Autoriza el Servicio:</label>
                                                                        <input type='text' id='txt_NomAutori' onkeyup='this.value = this.value.toUpperCase()' placeholder="C.C - NOMBRE" value="" class='form-control' />
                                                                    </div>
                                                                </div>
                                                                <div class='col-md-3'>
                                                                    <div class='form-group'>
                                                                        <label class='control-label'>Dirección:</label>
                                                                        <input type='text' id='txt_DirAut' onkeyup='this.value = this.value.toUpperCase()'  value="" class='form-control' />
                                                                    </div>
                                                                </div>
                                                                <div class='col-md-2'>
                                                                    <div class='form-group'>
                                                                        <label class='control-label'>Teléfono:</label>
                                                                        <input type='text' id='txt_TelAut' onkeyup='this.value = this.value.toUpperCase()'  value="" class='form-control' />
                                                                    </div>
                                                                </div>
                                                                <div class='col-md-3'>
                                                                    <div class='form-group'>
                                                                        <label class='control-label'>Jefe de Cementerio:</label>

                                                                        <input type='text' id='txt_NomJefe' onkeyup='this.value = this.value.toUpperCase()' value="FREDDY SIERRA" class='form-control' />
                                                                    </div>
                                                                </div>
                                                                <div class='col-md-12'>
                                                                    <div class='form-group'>
