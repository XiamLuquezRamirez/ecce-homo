...
<html lang="en" class="no-js">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Orden de Inhumaci&oacute;n | Funeraria La Esperanza </title>
        ...
        <script src="Js/GesOrdenInhumacion.js" type="text/javascript"></script>
                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            <li>
                                ...
                                <a href="GesOrdenInhumacion.php">Orden de Inhumaci&oacute;n</a>
                    ...
                    <ul class="nav nav-tabs">
                        <li class="active" id="tab_01_pp">
                            <a href="#tab_01" data-toggle="tab"> Listado de Inhumaciones</a>
                        </li>
                        <li id="tab_02_pp">
                            <a href="#tab_02" data-toggle="tab"  id="atitulo">Crear Orden de Inhumación</a>
                        </li>
                    </ul>
                                                        ...
                                                        <div class='row'>
                                                            ...
                                                            <div class='col-md-12'>
                                                                <div class="table-scrollable">
                                                                    ...
                                                                    <div id="tab_TipDoc" style="height: 370px;width: 1200px;overflow: scroll;">
                        ...
                        <div class="tab-pane fade" id="tab_02">
                            ...
                            <div class="portlet box purple-intense">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-angle-right"></i>Informaci&oacute;n de la Ixhumaci&oacute;n.
                                    </div>
                                    <div class="tools">
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane fade active in" id="tab_inf">
                                                ...
                                                <div class='portlet box blue'>
                                                    <div class='portlet-title'>
                                                        <div class='caption'>
                                                            <i class='fa fa-angle-right'></i>Datos De la Orden de Inhumaci&oacute;n
                                                        </div>
                                                        <div class='tools'>
                                                            <a href='javascript:;' class='collapse'></a>
                                                        </div>
                                                            ...
                                                            <div class='row'>
                                                                <div class='col-md-3'>
                                                                    <div class='form-group'><input type="hidden" id="cons" value="" /><input type="hidden" id="acc" value="1" /><input type="hidden" id="txt_id" value="1" /><input type="hidden" id="txt_fec" value="<?php echo date('Y-m-d'); ?>" />
                                                                        <label class='control-label'>Orden de Inhumaci&oacute;n No:</label>
                                                                ...
                                                                <div class='col-md-6'>
                                                                    <div class='form-group'>
                                                                        <label class='control-label'>Ocupado:</label>

                                                                        <input type='text' id='txt_NomOcupa'  value="" class='form-control' />
                                                                    </div>
                                                                </div>
                                                                <div class='col-md-6'>
                                                                    <div class='form-group'>
                                                                        ...
                                                                        <input type='text' id='txt_NomFalle' onkeyup='this.value = this.value.toUpperCase()' value="" class='form-control' />
                                                                    </div>
                                                                </div>
                                                                <div class='col-md-3'>
                                                                    <div class='form-group'>
                                                                        <label class='control-label'>Fecha Fallecido:</label>

                                                                        <input type='text' id='txt_fecha_fall' value="" class='form-control' readonly/>
                                                                    </div>
                                                                </div>
                                                                <div class='col-md-3'>
                                                                    <div class='form-group'>
                                                                        ...
                                                                        <input type='text' id='txt_fecha_nac' value="" class='form-control' readonly/>
                                                                    </div>
                                                                </div>
                                                                <div class='col-md-4'>
                                                                    <div class='form-group'>
                                                                        <label class='control-label'>Fecha Ceremonia:</label>

                                                                        <input type='text' id='txt_fecha_Cere' value="" class='form-control' readonly/>
                                                                    </div>
                                                                </div>
                                                                <div class='col-md-6'>
                                                                    <div class='form-group'>
