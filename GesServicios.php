...
<html lang="en" class="no-js">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Gesti&oacute;n de Precios | Funeraria La Esperanza </title>
        ...
        <script src="Js/GesServicios.js" type="text/javascript"></script>
                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                ...
                                <a href="GesServicios.php">Gesti&oacute;n de Precios  </a>
                            </li>
                        </ul>
                    </div>
                    <!-- END PAGE HEADER-->
                    ...
                    <div id="responsive" class="modal fade" tabindex="-1" data-width="760">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id='titformi'>Datos del Precio</h4>
                                            ...
                                            <div class='row'>
                                                ...
                                                <div class='col-md-3'>
                                                    <div class='form-group'>
                                                        ...
                                                        <input type='text'  onclick="this.select();" value="$ 0,00" onblur="textm(this.value, this.id)" id='txt_Val' class='form-control'/>
                                                    </div>
                                                </div>
                                                <div class='col-md-12'>
                                                    <div class='form-group'>
                    ...
                    <div class="portlet box purple-intense">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-angle-right"></i>Gesti&oacute;n de Precios
                            </div>
                            <div class="tools">
                                                            ...
                                                            <div class='row'>
                                                                <div class='col-md-12'>
                                                                    <div id="sample_1_filter" class="dataTables_filter">
                                                                        <label>
                                                                            Busqueda:
                                                                            <input class="form-control input-small input-inline"  onchange="$.busqServ(this.value);" id="busq_centro" type="search" placeholder="" aria-controls="sample_1">
                                                                        </label>
