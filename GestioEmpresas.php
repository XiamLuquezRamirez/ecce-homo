...
<html lang="en" class="no-js">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Gesti&oacute;n de Empresas | Funeraria La Esperanza </title>
        ...
        <script src="Js/GesEmpresas.js" type="text/javascript"></script>
                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                ...
                                <a href="GesClientes.php">Gesti&oacute;n de Empresas  </a>
                            </li>
                        </ul>
                    </div>
                    <!-- END PAGE HEADER-->
                    ...
                    <div id="responsive" class="modal fade" tabindex="-1" data-width="760">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id='titformi'>Datos de la Empresa</h4>
                                ...
                                <div class='portlet-body form'>
                                    <form action='#' id="formnot" class='horizontal-form'>
                                        <div class='form-body'>
                                            ...
                                            <div class='row'>
                                                <div class='col-md-3'>
                                                    <div class='form-group'><input type="hidden" id="acc" value="1" /><input type="hidden" id="text_id" value="1" />
                                                ...
                                                <div class='col-md-3'>
                                                    <div class='form-group'>
                                                        ...
                                                        <input type='text'  onkeyup='this.value = this.value.toUpperCase()' id='txt_Cel' class='form-control'/>
                                                    </div>
                                                </div>
                                                <div class='col-md-6'>
                                                    <div class='form-group'>
                                                        <label class='control-label'>E-Mail:</label>
                                                        <input type='text'  onkeyup='this.value = this.value.toUpperCase()' id='txt_email' class='form-control'/>
                                                    </div>
                                                </div>
                                                <div class='col-md-6'>
                                                    <div class='form-group'>
                                                        <label class='control-label'>Persona de Contacto:</label>
                                                        <input type='text'  onkeyup='this.value = this.value.toUpperCase()' id='txt_Conta' class='form-control'/>
                                                    </div>
                                                </div>
                                                <div class='col-md-4'>
                                                    <div class='form-group'>
                                                        <label class='control-label'>Cobrador:</label>
                                                        <input type='text'  onkeyup='this.value = this.value.toUpperCase()' id='txt_Cobr' class='form-control'/>
                                                    </div>
                                                </div>
                                                <div class='col-md-3'>
                                                    <div class='form-group'>
                                                        <label class='control-label'>Fecha de Afiliaci&oacute;n:</label>
                                                        <input type='text' id='txt_fecha_Afil' value="" class='form-control' readonly/>
                                                    </div>
                                                </div>
                                                <div class='col-md-12'>
                                                    <div class='form-group'>
                    ...
                    <div class="portlet box purple-intense">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-angle-right"></i>Gesti&oacute;n de Empresas
                            </div>
                            <div class="tools">
                                                            ...
                                                            <div class='row'>
                                                                <div class='col-md-12'>
                                                                    <div id="sample_1_filter" class="dataTables_filter">
                                                                        <label>
                                                                            Busqueda:
                                                                            <input class="form-control input-small input-inline"  onchange="$.busqClie(this.value);" id="busq_centro" type="search" placeholder="" aria-controls="sample_1">
                                                                        </label>
