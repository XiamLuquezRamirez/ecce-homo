...
<html lang="en" class="no-js">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Gesti&oacute;n de Consecutivos | Funeraria La Esperanza </title>
                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            <li>
                                ...
                                <a href="../ParaGnerales.php">Parametros Generales</a>
                                <i class="fa fa-angle-right"></i>
                            </li>
                            <li>
                                <i class="fa fa-cube"></i>
                                <a href="GesConsecutivos.php">Gesti&oacute;n de Consecutivos  </a>
                            </li>
                        </ul>
                    </div>
                    <!-- END PAGE HEADER-->
                    ...
                    <div id="responsive" class="modal fade" tabindex="-1" data-width="800">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id='titformi'>Datos del Consecutivos</h4>
                            ...
                            <div class="row">
                                <div class='portlet-body form'>
                                    ...
                                    <div class='form-body'>
                                        <div class='row'>
                                            <div class='col-md-2'>
                                                <div class='form-group'><input type="hidden" id="acc" value="1" /><input type="hidden" id="txt_id" value="1" />
                                            ...
                                            <div class='col-md-4'>
                                                <div class='form-group'>
                                                    ...
                                                    <select class='form-control' id="CbGrupo" name="options2">
                                                        <option value=" ">Select...</option>
                                                        <option value="PREVISION">CONTRATO DE PREVISI&Oacute;N ANUAL EXEQUIAL</option>
                                                        <option value="REQUISICION">REQUISICI&Oacute;N INTERNA</option>
                                                        <option value="CONARRINUEVO">CONTRATO DE ARRIENDO CEMENTERIO NUEVO</option>
                                                        <option value="CONARRIECCE">CONTRATO DE ARRIENDO ECCE HOMO</option>
                                                        <option value="CONVENTA">CONTRATO DE VENTA</option>
                                                        <option value="CONSTANCIAS">CONSTANCIAS DE CONSIGNACI&Oacute;N</option>
                                                        <option value="FACTURA">FACTURA DE VENTA</option>
                                                        <option value="RECIBO">RECIBO DE PAGO</option>
                                                        <option value="RECIBOPAE">RECIBO DE PAGO PAE</option>
                                                        <option value="EXHUMACION">ORDEN DE EXHUMACI&Oacute;N</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class='col-md-6'>
                                            ...
                                            <div class='col-md-2'>
                                                <div class='form-group'>
                                                    ...
                                                    <input type='text' disabled  onkeyup='this.value = this.value.toUpperCase()' id='txt_act' class='form-control'/>
                                                </div>
                                            </div>
                                            <div class='col-md-3'>
                                                <div class='form-group'>
                    ...
                    <div class="portlet box purple-intense">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-angle-right"></i>Gesti&oacute;n de Consecutivos
                            </div>
                            <div class="tools">
                                                            ...
                                                            <div class='row'>
                                                                <div class='col-md-12'>
                                                                    <div id="sample_1_filter" class="dataTables_filter">
                                                                        <label>
                                                                            Busqueda:
                                                                            <input class="form-control input-small input-inline" onkeypress="$.busqEvid(this.value);" onchange="$.busqEvid(this.value);" id="busq_centro" type="search" placeholder="" aria-controls="sample_1">
                                                                        </label>
