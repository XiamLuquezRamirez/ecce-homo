...
$consulta = "INSERT INTO facturas_requi VALUES(null,'" . $_POST['consec'] . "','" . $_POST['fcreac'] . "',"
        ...
        . "'" . $_POST['txt_NomFall'] . "','" . $_POST['txt_FecNacFall'] . "')";
...
$id_cosnt = "";
$sql = "SELECT MAX(id_fact) AS id FROM facturas_requi";
...
for ($i = 1; $i <= $Tam_Concep; $i++) {
    ...
    $consulta2 = "INSERT INTO detalles_facturarequi VALUES(null,'" . $id_cosnt . "','" . $parConcep[0] . "','" . $parConcep[1] . "'," . $parConcep[2] . ")";
    //echo $consulta2;
...
$consulta = "INSERT INTO logs (usuario_id, log_direccion, log_fecha,
            ...
            NOW(),'Registro de Factura " . $_POST['consec'] . "' ,'INSERCION', 'GesRequisicion.php')";
