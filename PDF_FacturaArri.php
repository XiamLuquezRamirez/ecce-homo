...
$consulta = "SELECT * FROM facturas_arriendo where id_fact='" . $_REQUEST["id"] . "'";
...
//        $this->SetXY(10, 60);
//        $this->Cell(20, 8, utf8_decode('NOMBRE DEL DIFUNTO: '.$GLOBALS['nomb_difunto']), 0, 'L');
//        $this->SetXY(120, 60);
//        $this->Cell(20, 8, utf8_decode('FECHA DE FALLECIMIENTO: '.$GLOBALS['fech_muert']), 0, 'L');
//  //      $this->Line(10, 68.5, 200, 68.5);
        //*****
    }
    ...
    function TablaConceptos() {
        ...
        $this->Cell(110, 8, utf8_decode('Descripción.'), 0, 0, 'L', True);
        ...
        $this->MultiCell(110, 5, utf8_decode(acentos($GLOBALS['detalle'])), 0);
        ...
        $this->Cell(15, $height, '1', 0, 0, 'C');

        $this->SetXY(140, $Y);

        $this->Cell(30, $height, '$ ' . number_format($GLOBALS['valor'], 2, ",", "."), 0, 0, 'R');

        $this->SetXY(170, $Y);

        $this->Cell(0, $height, '$ ' . number_format($GLOBALS['valor'], 2, ",", "."), 0, 0, 'R');
...
//        $this->Cell(145, 6, 'VALOR EN LETRA. ' . $GLOBALS['val_letra'], 1, 0, 'L');
        ...
        $this->Cell(0, 6, '$ ' . number_format($GLOBALS['valor'], 2, ",", "."), 1, 0, 'R');
...
$pdf->Output('I', 'FacturaArriendo_' . $cons_fact . '.pdf');
