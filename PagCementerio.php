...
if ($busq != "") {
    ...
    $consulta = "SELECT * FROM  cementerios  WHERE ";
    ...
    $consulta .= " order by nom_cem ASC LIMIT " . $regemp . "," . $regmos;
} else {

    $consulta = "SELECT * FROM cementerios order by nom_cem ASC  LIMIT " . $regemp . "," . $regmos;
}
...
if (mysqli_num_rows($resultado) > 0) {
    ...
    while ($fila = mysqli_fetch_array($resultado)) {
        ...
        $cad .= "<tr>"
                ...
                . "</td>"
                . "<td class=\"highlight\">"
                . acentos($fila["nom_cem"]) . ""
                . "</td>"
                . "<td class=\"highlight\">"
                . "<a  onclick=\"$.editCeme('" . $cod . "')\"  class=\"btn default btn-xs blue\">"
                . "<i class=\"fa fa-edit\"></i> Editar</a>"
                . "<a   onclick=\"$.VerCeme('" . $cod . "')\"  class=\"btn default btn-xs blue\">"
                . "<i class=\"fa fa-search\"></i> Ver</a>"
                . "<a onclick=\"$.deletCeme('" . $cod . "')\" class=\"btn default btn-xs red\">"
...
$consulta = "SELECT count(*) as conta FROM cementerios";
