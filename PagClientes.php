...
$cad = "<table class=\"table table-striped table-bordered table-advance table-hover\">"
        ...
        . "</th>"
        . "<th>"
        . "<i class=\"fa fa-angle-right\"></i> Direcci&oacute;n"
        . "</th>"
        . "<th>"
...
if ($busq != "") {
    ...
    $consulta = "SELECT * FROM clientes WHERE estado='ACTIVO' order by nom_cli ASC  LIMIT " . $regemp . "," . $regmos;
}
//echo $consulta;
...
$consulta = "SELECT count(*) as conta FROM clientes WHERE estado='ACTIVO' ";
