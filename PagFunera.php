...
if ($busq != "") {
    ...
    $consulta = "SELECT * FROM  funerarias  WHERE ";
    ...
    $consulta .= " order by nom_fune ASC LIMIT " . $regemp . "," . $regmos;
} else {

    $consulta = "SELECT * FROM funerarias order by nom_fune ASC  LIMIT " . $regemp . "," . $regmos;
}
...
if (mysqli_num_rows($resultado) > 0) {
    ...
    while ($fila = mysqli_fetch_array($resultado)) {
        ...
        $cad .= "<tr>"
                ...
                . "</td>"
                . "<td class=\"highlight\">"
                . "<a  onclick=\"$.editFune('" . $cod . "')\"  class=\"btn default btn-xs blue\">"
                . "<i class=\"fa fa-edit\"></i> Editar</a>"
                . "<a   onclick=\"$.VerFune('" . $cod . "')\"  class=\"btn default btn-xs blue\">"
                . "<i class=\"fa fa-search\"></i> Ver</a>"
                . "<a onclick=\"$.deletFune('" . $cod . "')\" class=\"btn default btn-xs red\">"
...
$consulta = "SELECT count(*) as conta FROM funerarias";
