...
if ($busq != "") {
    ...
    $consulta = "SELECT * FROM  galerias  WHERE ";
    ...
    $consulta = "SELECT * FROM galerias order by fecha ASC  LIMIT " . $regemp . "," . $regmos;
}
...
if (mysqli_num_rows($resultado) > 0) {
    ...
    while ($fila = mysqli_fetch_array($resultado)) {
        ...
        $cad .= "<tr>"
                ...
                . "</td>"
                . "<td class=\"highlight\">"
                . "<a  onclick=\"$.editGal('" . $cod . "')\"  class=\"btn default btn-xs blue\">"
                . "<i class=\"fa fa-edit\"></i> Editar</a>"
                . "<a   onclick=\"$.VerGal('" . $cod . "')\"  class=\"btn default btn-xs blue\">"
                . "<i class=\"fa fa-file-image-o\"></i> Imagenes</a>"
                . "<a onclick=\"$.deletGal('" . $cod . "')\" class=\"btn default btn-xs red\">"
...
$consulta = "SELECT count(*) as conta FROM galerias";
