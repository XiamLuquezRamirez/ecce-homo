...
if ($busq != "") {
    ...
    $consulta = "SELECT * FROM  iglesias  WHERE ";
    ...
    $consulta .= " order by nom_igle ASC LIMIT " . $regemp . "," . $regmos;
} else {

    $consulta = "SELECT * FROM iglesias order by nom_igle ASC  LIMIT " . $regemp . "," . $regmos;
}
...
if (mysqli_num_rows($resultado) > 0) {
    ...
    while ($fila = mysqli_fetch_array($resultado)) {
        ...
        $cad .= "<tr>"
                ...
                . "</td>"
                . "<td class=\"highlight\">"
                . acentos($fila["nom_igle"]) . ""
                . "</td>"
                . "<td class=\"highlight\">"
                . "<a  onclick=\"$.editIgle('" . $cod . "')\"  class=\"btn default btn-xs blue\">"
                . "<i class=\"fa fa-edit\"></i> Editar</a>"
                . "<a   onclick=\"$.VerIgle('" . $cod . "')\"  class=\"btn default btn-xs blue\">"
                . "<i class=\"fa fa-search\"></i> Ver</a>"
                . "<a onclick=\"$.deletIgle('" . $cod . "')\" class=\"btn default btn-xs red\">"
...
$consulta = "SELECT count(*) as conta FROM iglesias";
